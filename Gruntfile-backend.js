module.exports = function(grunt) {
    ...
    var appConfig = {
        ...
        //
        **************************************************************************/
        devDeployDir: 'rcloud.rcap-develop',
        distDeployDir: 'rcloud.rcap-dist',
    ...
    grunt.registerTask('default', ['newer:jshint', 'clean:dev', 'copy:dev']);

    // dist, build production code:
    grunt.registerTask('dist', ['newer:jshint', 'clean:dist', 'copy:dist', /*, 'open'*/ ]);
