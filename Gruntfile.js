module.exports = function(grunt) {
    ...
    // dev
    grunt.registerTask('default', ['newer:jshint', 'clean:dev', 'copy:dev', 'sass', 'shell:buildpackage', 'shell:installpackage', 'clean:outputtemp']);
    grunt.registerTask('buildpackage', ['newer:jshint', 'clean:dev', 'copy:dev', 'sass', 'shell:buildpackage']);
